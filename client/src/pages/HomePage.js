		...
		<>
			...
			<div className='min-h-[350px] bg-white py-24 text-black gap-9 flex flex-col lg:flex-row items-center justify-center'>
				<div className='hidden lg:grid mx-4'>
					<p className='font-black text-7xl tracking-wider'>
						We help
					</p>
					<p className='font-black text-7xl tracking-wider '>
						you find
				...
				<div className='flex flex-col px-4 lg:hidden w-full'>
					...
					<p className='grid lg:hidden pt-12 tracking-widest max-w-[700px] leading-6 text-xl'>
						...
						Beatae perspiciatis placeat ipsa maiores. Nostrum iste
						architecto expedita amet omnis dolor nihil et
						laudantium. Voluptas neque rerum veritatis vitae
						accusamus id.
					</p>
				</div>
				<p className='tracking-widest hidden lg:grid max-w-[700px] leading-6 text-xl'>
					Lorem ipsum dolor, sit amet consectetur adipisicing elit.
					Itaque dolore nemo deleniti nihil molestias ex explicabo cum
					quaerat? Vel sequi sunt impedit nulla omnis quisquam porro
					modi excepturi consequatur alias. Obcaecati vitae veritatis
					iusto facere accusamus perferendis.
				</p>
			</div>
